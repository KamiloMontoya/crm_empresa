...
<div class="row">
	<div class="col-6">
        ...
        <div class="form-group">
            <label>Email</label>
            <input type="email" class="form-control"  class="@if($errors->has('email')) is-invalid @endif" name="email" value="{{ isset($contact) ? $contact->email : old('email') }}" placeholder="Nombre">
            @if($errors->has("email"))
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"  class="@if($errors->has('address')) is-invalid @endif" name="address" value="{{ isset($contact) ? $contact->address :  old('address') }}" placeholder="Nombre">
        ...
        <div class="form-group">
            <label>Ciudad</label>
            <input type="text" class="form-control"  class="@if($errors->has('city')) is-invalid @endif" name="city" value="{{ isset($contact) ? $contact->city :  old('city') }}" placeholder="Nombre">
            @if($errors->has("city"))
	...
	<div class="col-6">
		...
		<div class="form-group">
            ...
            <input type="text" class="form-control"  class="@if($errors->has('phone')) is-invalid @endif" name="phone" value="{{ isset($contact) ? $contact->phone :  old('phone') }}" placeholder="Nombre">
            @if($errors->has("phone"))
        ...
        <div class="form-group">
            <label>Celular</label>
            <input type="text" class="form-control"  class="@if($errors->has('celphone')) is-invalid @endif" name="celphone" value="{{  isset($contact) ? $contact->celphone : old('celphone') }}" placeholder="Nombre">
