...
<div class="row">
	<div class="col-12 col-sm-12">
		<div class="form-group">
            ...
            <input type="text" class="form-control @if($errors->has('name')) is-invalid @endif" name="name" value="{{ isset($service_status) ? $service_status->name : old('name') }}" {{ isset($service_status) ? 'readonly' : '' }} placeholder="Nombre">
            @if($errors->has("name"))
        ...
        <div class="form-group">
            <label>Nombre</label>
            <input type="text" class="form-control @if($errors->has('long_name')) is-invalid @endif" name="long_name" value="{{ isset($service_status) ? $service_status->long_name : old('long_name') }}" placeholder="Nombre">
        ...
        <div class="form-group">
            <?php $checked = isset($service_status) ? $service_status->is_default : old('is_default') ?>
