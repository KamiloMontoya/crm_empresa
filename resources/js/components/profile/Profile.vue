    ...
    <div class="row justify-content-md-center">
      <div class="col-md-9 col-xl-7">
        <div class="card-header px-0 mt-2 bg-transparent clearfix">
          <h4 class="float-left pt-2">Edita Perfil</h4>
        ...
        <div class="card-body px-0">
          <form class="form-horizontal" v-if="!loading">
            <div class="form-group row justify-content-md-center">
              ...
              <div class="col-md-9">
                <small class="form-text text-muted mb-3">Puedes cambiar tu avatar aquí o eliminar el avatar actual</small>
            ...
            <div class="form-group row justify-content-md-center">
              ...
              <div class="col-md-9">
                ...
                <small class="form-text text-muted">Ingrese su nombre para que las personas que conozca lo reconozcan.</small>
